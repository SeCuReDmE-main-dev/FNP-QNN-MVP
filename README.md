...
<p align="center">
  <a href="https://doi.org/10.5281/zenodo.21893181"><img alt="Zenodo DOI: 10.5281/zenodo.21893181" src="https://img.shields.io/badge/Zenodo%20DOI-10.5281%2Fzenodo.21893181-1682D4?style=for-the-badge" /></a>
</p>
...
The application exposes read-only operational diagnostics at `/cpai/status`
and `/cpai/mesh`, backed by the repository-local node on port `32172`. The
scientific engine keeps routing decisions side-effect free; actual network
health is obtained only through this bounded connector or the shared Gateway.
